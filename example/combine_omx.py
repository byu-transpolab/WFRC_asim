...
manifest_dir = 'scripts'
source_data_dir = 'scripts'
dest_data_dir = 'scripts'

manifest_file_name = os.path.join(manifest_dir, 'skims_manifest.csv')
dest_file_name = os.path.join(dest_data_dir, 'skims_wfrc.omx')
